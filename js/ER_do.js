        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                ...
                <ul>
                    ...
                    <li>/do 使用夾板實施「跨關節固定」，維持肢體軸線穩定</li>
                </ul>
            </div>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 給予 Keto 30mg 止痛後，進行徒手牽引復位 (Reduction)</p>
                    <p>/do 使用石膏捲施作支架固定，並確認肢體血循功能</p>

                    <strong>3. 開放性：I&D 術與內固定 (ORIF)</strong>
                    <p><strong>[步驟一：高壓沖洗]</strong></p>
                    <p>/do 使用 3000-6000ml 生理食鹽水對傷口執行高壓脈衝沖洗，移除汙染物</p>
                    <p><strong>[步驟二：外科清創]</strong></p>
                    <p>/do 使用手術刀切除失活的肌肉與受汙染的骨碎片</p>
                    <p>/do 執行傷口延伸切開 (Wound Extension)，逐層分離組織以暴露骨折斷端</p>
                    
                    <p><strong>[步驟三：解剖復位與內固定]</strong></p>
                    <p>/do 暴露骨折端，使用復位鉗 (Reduction Forceps) 將骨骼對齊</p>
                    <p>/do 於骨幹表面鎖上鈦合金鋼板 (Plate) 與自攻螺絲 (Screws) 進行牢固固定</p>
                    <p>/do 縫合血管與神經，確保血流與神經功能恢復</p>
                    <p>/do 將切口處的肌肉和組織依層縫合</p>
                    <p>/do 縫合皮膚表面，確保傷口閉合</p>
                    <p>/do 覆蓋無菌敷料</p>
                    <p>/do 放置石膏固定患肢</p>
                </div>
            </div>
        ...
        <div class="dashboard-grid">
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 建立雙側大口徑靜脈管路，啟動加溫輸液</p>
                    <p>/do 靜脈推注 Morphine 5mg 進行強效止痛，緩解神經性休克</p>
                    <p>/do 使用 Betadine (優碘) 由傷口中心向外擴大消毒 3 圈</p>
                    <p>/do 鋪設無菌單並使用 Lidocaine 2% 沿彈道徑路浸潤麻醉</p>
                    
                    <strong>2. 創面擴創術 (Wound Track Exploration)</strong>
                    <p>/do 使用 #15 手術刀沿彈頭路徑執行擴大切開，移除汙染之組織</p>
                    <p>/do 使用血管鉗 (Kelly) 輕柔探查彈道，避免損傷鄰近之神經叢</p>
                    

                    <strong>3. 彈頭移除 (Bullet Extraction)</strong>
                    <p>/do 定位彈頭後，使用專用取彈鉗 (Bullet Forceps) 穩固夾取</p>
                    <p>/do 完整取出彈頭，檢查有無碎片殘留，並保存為證物</p>
                    <p>/do 使用大量生理食鹽水進行彈道內高壓沖洗</p>
                    

                    <strong>4. 血管修補與閉合</strong>
                    <p>/do 使用 Prolene 5-0 縫線修補受損之小血管</p>
                    <p>/do 使用可吸收縫線執行縫合，保留傷口彈性</p>
                </div>
            </div>
        </div>
    </div>`;
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🚑 EMS 現場穩定程序</h3>
                <ul>
                    <li>/do 檢查患肢末梢脈搏與感覺，評估有無神經受壓</li>
                    <li>/do 保持脫臼姿勢固定，切勿在現場強力自行復位</li>
                    <li>/do 使用三角巾或充氣夾板固定關節上下兩端</li>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 靜脈推注 Propofol (異丙酚) 進行深層鎮靜，使肌肉完全放鬆</p>
                    <p>/do 於關節囊周圍注射 Lidocaine 2% 執行關節內麻醉</p>
                    
                    <strong>2. 徒手復位術 (Closed Reduction)</strong>
                    <p>/do 執行 相對應復位術 進行持續牽引</p>
                    <p>/do 聽到「咔」一聲(Click)並觀察到關節輪廓恢復正常</p>
                    

                    <strong>3. 切開復位手術 (Open Reduction)</strong>
                    <p><em>※ 若徒手復位失敗或有關節囊嵌入時執行：</em></p>
                    <p>/do 使用 #15 手術刀切開皮膚，暴露受阻礙之關節腔</p>
                    <p>/do 使用復位鉗撥開夾雜之軟組織，將關節頭導回關節窩</p>
                    <p>/do 使用可吸收縫線修補受損之關節囊與韌帶</p>
                    
                    <strong>4. 表皮免拆線縫合 (Closure)</strong>
                    <p>/do 使用 4-0 Monocryl 可吸收線執行「皮內縫合」 (Subcuticular Stitch)</p>
                    <p>/do 將縫線完全隱埋於真皮層內，利用人體水解自行吸收</p>
                    <p>/do 於傷口表面塗抹 Dermabond (醫用膠水) 形成抗菌保護膜</p>

                    <strong>5. 固定與後續</strong>
                    <p>/do 使用石膏支架 (Splint) 將關節固定於功能位置，限制活動</p>
        ...
        <div class="dashboard-grid">
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 使用 #10 刀片執行弧形切開，翻開頭皮瓣並以止血鉗固定出血點</p>
                    <p>/do 使用氣動鑽 (Cranial Drill) 於顱骨執行三處定位鑽孔</p>
                    
                    <p>/do 使用銑刀 (Gigli saw/Craniotome) 連接孔洞，取下骨瓣並浸泡於生理食鹽水中</p>
                    
                    <strong>2. 硬腦膜切開與清創 (Evacuation)</strong>
                    <p>/do 使用 #11 尖刀小心切開硬腦膜 (Dura)，顯露下方之暗紅色血塊</p>
