        ...
        <div class="clinical-dashboard">
            ...
            <div class="dashboard-grid">
                <div class="panel pre-hospital">
                    <h3>🚑 EMS 現場穩定程序</h3>
                    <ul>
                        <li>/do 使用 500ml 生理食鹽水由中心向外執行高壓噴射沖洗</li>
                        <li>/do 覆蓋濕潤無菌敷料，預防組織與紗布乾涸黏連</li>
                    </ul>
                </div>
                <div class="panel in-hospital">
                    ...
                    <div class="procedure-box">
                        ...
                        <p>/do 以 生理食鹽水 進行二次潤濕與物理性異物移除</p>
                        <p>/do 以 Betadine (優碘) 由內向外執行環狀消毒 3 圈</p>
                        
                        <strong>2. 藥物預防與評估</strong>
                        <p>/do 於傷口基部均勻塗抹 Neomycin (新黴素軟膏)</p>
                        
                        <strong>3. 封閉式包紮</strong>
                        <p>/do 放置 Telfa 不沾黏敷料作為首層介面</p>
                        <p>/do 使用捲軸紗布執行 8 字型固定</p>
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🚑 EMS 現場初步處置</h3>
                <ul>
                    <li>/do 使用無菌生理食鹽水潤濕紗布，覆蓋開放性創口</li>
                    <li>/do 執行遠端 CSM 檢查，確認有無神經血管受壓徵兆</li>
                    <li>/do 使用夾板實施「跨關節固定」，維護肢體軸線穩定</li>
                </ul>
            </div>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 執行患肢 AP/Lateral 雙向 X 光，確認骨折類型與移位程度</p>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 10px; margin: 10px 0;">
                        ...
                        <div style="background: rgba(59, 130, 246, 0.1); border-left: 4px solid #3b82f6; padding: 10px 12px; border-radius: 4px;">
                            ...
                            <p style="margin-bottom: 4px;">/do 給予 Keto 30mg 止痛後，進行徒手牽引復位 (Reduction)</p>
                            <p style="margin: 0;">/do 使用石膏捲施作支架固定，並確認肢體血循功能</p>
                        </div>
                        ...
                        <div style="background: rgba(239, 68, 68, 0.1); border-left: 4px solid #ef4444; padding: 10px 12px; border-radius: 4px;">
                            ...
                            <p style="margin-bottom: 8px;">/do 使用 3000-6000ml 生理食鹽水對傷口執行高壓脈衝沖洗，移除汙染物</p>
                            
                            <p style="margin-bottom: 4px;"><strong>[步驟二：外科清創]</strong></p>
                            <p style="margin-bottom: 4px;">/do 使用手術刀切除失活的肌肉與受汙染的骨碎片</p>
                            <p style="margin-bottom: 8px;">/do 執行傷口延伸切開 (Wound Extension)，逐層分離組織以暴露骨折斷端</p>
                            
                            <p style="margin-bottom: 4px;"><strong>[步驟三：解剖復位與內固定]</strong></p>
                            <p style="margin-bottom: 4px;">/do 暴露骨折端，使用復位鉗 (Reduction Forceps) 將骨骼對齊</p>
                            <p style="margin-bottom: 4px;">/do 於骨幹表面鎖上鈦合金鋼板 (Plate) 與自攻螺絲 (Screws) 進行牢固固定</p>
                            <p style="margin-bottom: 4px;">/do 縫合血管與神經，確保血流與神經功能恢復</p>
                            <p style="margin-bottom: 4px;">/do 將切口處的肌肉和組織依層縫合</p>
                            <p style="margin-bottom: 4px;">/do 縫合皮膚表面，確保傷口閉合</p>
                            <p style="margin-bottom: 4px;">/do 覆蓋無菌敷料</p>
                            <p style="margin: 0;">/do 放置石膏固定患肢</p>
                        </div>
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🚑 EMS 現場處理</h3>
                <ul>
                    <li>/do 流動清水沖洗後使用無菌生理食鹽水潤濕紗布覆蓋</li>
                </ul>
            </div>
            <div class="panel in-hospital">
                <h3>🏥 院內照護程序</h3>
        ...
        <div class="dashboard-grid">
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 以無菌針頭抽吸大面積張力性水泡，並保留水泡皮作為天然屏障</p>
                    <strong>2. 藥物應用</strong>
                    <p>/do 於創面覆蓋厚層 SSD (銀磺胺嘧啶) 抗菌藥膏</p>
                    <strong>3. 進階包紮</strong>
                    <p>/do 覆蓋石蠟紗布避免敷料黏連，並以捲軸紗布輕輕固定</p>
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🚑 EMS 現場急救程序</h3>
                <ul>
                    <li>/do 建立雙側 14G 大口徑靜脈管路，啟動快速輸液</li>
                    <li>/do 移除戒指與手錶，預防組織腫脹導致遠端缺血</li>
                    <li>/do 以乾燥無菌布單包裹患部</li>
                </ul>
            </div>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 使用 Goulian 刮刀或手術刀逐層刮除皮革狀壞死組織 (Eschar)</p>
                    <p>/do 以 3000ml 生理食鹽水配合脈衝式沖洗系統進行創面除菌</p>

                    <strong>4. 創面覆蓋與藥物</strong>
                    <p>/do 均勻塗抹 SSD (銀磺胺嘧啶) 抗菌藥膏於所有切口與創面</p>
        ...
        <div class="dashboard-grid">
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 以生理食鹽水大量沖洗傷口，移除表淺異物</p>
                    <p>/do 使用 Betadine (優碘) 由內向外執行環狀消毒</p>
                    <p>/do 施打 Lidocaine 2% 進行局部浸潤麻醉</p>
                    
                    <strong>2. 免拆線縫合技術 (Absorbable Suture)</strong>
                    <p>/do 使用Vicryl (可吸收縫線) 執行皮內縫合</p>
                    <p>/do 針對表皮細微裂縫，塗抹 Dermabond (醫用傷口膠水) 加固封閉</p>
                    
                    <strong>3. 傷口保護與藥物</strong>
                    <p>/do 於表面塗抹 Neomycin (新黴素軟膏)</p>
                    <p>/do 覆蓋防水透明敷料 (Tegaderm)</p>
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🚑 EMS 現場減壓程序</h3>
                <ul>
                    <li>/do 於患側第二肋間與鎖骨中線交點執行「針刺減壓術」</li>
                    <li>/do 使用 14G 靜脈導管刺入胸膜腔，釋放高壓氣體</li>
                    <li>/do 若有開放性傷口，使用「三邊封閉敷料」建立單向瓣膜</li>
                    <li>/do 給予 15L/min 高流量氧氣，維持血氧飽和度 > 94%</li>
                </ul>
            </div>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 置入 30Fr 胸腔引流管，胸管導向胸腔後上方 (Posterior-Apex)，兼顧排氣與排血</p>
                    <p>/do 接上三腔式水封引流瓶 (Pleur-evac)，觀察是否有氣泡溢出</p>
                    <p>/do 使用可吸收縫線執行「錢包縫合」固定管路，並覆蓋凡士林紗布</p>
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🏥 與術前前置</h3>
                <ul>
                    <li>/do 執行氣管插管 (ET Tube) 並連結呼吸器給予 100% 氧氣</li>
                    <li>/do 開放雙側大口徑靜脈 (14G)，啟動大量輸液加溫器</li>
                    <li>/do 使用 10% Betadine (優碘) 迅速塗抹左側胸壁至腋下區域</li>
                    <li>/do 鋪設無菌單 (Draping)，僅暴露第四至第五肋間預計切口處</li>
                    <li>/do 靜脈推注 Propofol (異丙酚) 進行快速序列麻醉誘導 (RSI)</li>
                </ul>
            </div>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 置入 Finochietto (開胸器) 並旋轉手把強力撐開肋骨</p>
                    <p>/do 手動撥開肺葉，清除胸腔內積血，顯露縱膈腔與心包膜</p>

                    <strong>3. 核心止血與復甦 (The "Golden Moments")</strong>
                    <p>/do 執行主動脈夾閉 (Aortic Cross-clamping) 將血液保留至腦部</p>
                    <p>/do 使用血管鉗 (Kelly) 夾閉肺門大血管出血點，並以 Prolene 線縫合肺葉撕裂處</p>

                    <strong>4. 關閉胸腔與引流</strong>
                    <p>/do 置入 32Fr 胸管至肺底，連接水封瓶確認肺部重張狀況</p>
                    <p>/do 使用強力可吸收縫線進行肋骨對合，並逐層密合胸壁肌肉與皮膚</p>
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🚑 EMS 創傷穩定程序</h3>
                <ul>
                    <li>/do 使用無菌生理食鹽水紗布覆蓋擦傷創面</li>
                    <li>/do 評估傷口深淺，確認無深層大出血或彈頭滯留跡象</li>
                </ul>
            </div>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 使用 500ml 生理食鹽水對擦傷創面進行高壓噴射沖洗，移除火藥殘渣與異物</p>
                    <p>/do 使用 Betadine (優碘) 由創面中心向外擴大環狀消毒 3 圈</p>

                    <strong>2. 藥物預防與抗感染</strong>
                    <p>/do 於表皮擦傷處均勻塗抹 Neomycin (新黴素抗生素軟膏) 預防感染</p>
                    <p>/do 靜脈注射破傷風疫苗 (Tetanus Toxoid) 預防深層組織感染</p>

                    <strong>3. 敷料包紮與衛教</strong>
                    <p>/do 放置 Telfa 不沾黏無菌敷料作為首層保護介面</p>
                    <p>/do 使用捲軸紗布進行適度加壓包紮，並確認遠端血循正常</p>
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🚑 EMS 創傷穩定程序</h3>
                <ul>
                    <li>/do 使用無菌加壓敷料對傷口執行直接加壓止血</li>
                    <li>/do 檢查有無貫穿性出口創口 (Exit Wound)，並確認遠端血循與神經功能</li>
                </ul>
            </div>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    <strong>1. 術前準備與麻醉</strong>
                    <p>/do 建立雙側大口徑靜脈管路，啟動加溫輸液與生命徵象監測</p>
                    <p>/do 靜脈推注 Morphine 5mg 進行強效止痛，緩解神經性休克</p>
                    <p>/do 使用 Betadine (優碘) 由傷口中心向外擴大消毒 3 圈並鋪設無菌單</p>
                    <p>/do 使用 Lidocaine 2% 沿彈道徑路執行浸潤麻醉</p>

                    <strong>2. 創面擴創與彈道探查</strong>
                    <p>/do 使用 15號 手術刀沿彈頭路徑執行擴大切開，移除汙染與壞死組織</p>
                    <p>/do 使用血管鉗 (Kelly) 輕柔探查彈道，避免損傷鄰近之神經血管</p>

                    <strong>3. 彈頭取出手術</strong>
                    <p>/do 定位彈頭後，使用專用取彈鉗 (Bullet Forceps) 穩固夾取並完整取出</p>
                    <p>/do 檢查彈頭有無碎片殘留，並將彈頭封存於證物袋中</p>
                    <p>/do 使用大量生理食鹽水進行彈道深層高壓脈衝沖洗</p>

                    <strong>4. 血管修補與層級縫合</strong>
                    <p>/do 使用 Prolene 5-0 縫線修補受損之微血管</p>
                    <p>/do 使用可吸收縫線進行肌肉與皮下組織分層縫合</p>
                    <p>/do 縫合皮膚表層，覆蓋無菌敷料並完成加壓包紮</p>
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🚑 EMS 現場初步處置</h3>
                <ul>
                    <li>/do 檢查患肢末梢 CSM (神經/血循/運動)，評估有無神經受壓徵兆</li>
                    <li>/do 保持脫臼姿勢固定，切勿在現場強力自行復位</li>
                    <li>/do 使用三角巾或充氣夾板實施固定，維護關節兩端穩定</li>
                    <li>/do 冰敷受損關節，緩解內部出血與急性腫脹</li>
                </ul>
            </div>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 執行患肢 AP/Lateral X 光，評估關節脫臼方向與是否合併骨折</p>
                    <p>/do 靜脈推注 Propofol (異丙酚) 進行深層鎮靜/麻醉，使肌肉完全放鬆</p>
                    <p>/do 於關節囊周圍注射 Lidocaine 2% 執行關節內麻醉</p>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 10px; margin: 10px 0;">
                        ...
                        <div style="background: rgba(59, 130, 246, 0.1); border-left: 4px solid #3b82f6; padding: 10px 12px; border-radius: 4px;">
                            ...
                            <p style="margin-bottom: 4px;">/do 執行相對應復位手法進行持續牽引與角度校正</p>
                            <p style="margin-bottom: 4px;">/do 聽到「咔」一聲 (Click) 並觀察到關節解剖輪廓恢復正常</p>
                            <p style="margin: 0;">/do 重新確認末梢脈搏與神經感知功能，並施作石膏支架 (Splint) 固定</p>
                        </div>
                        ...
                        <div style="background: rgba(239, 68, 68, 0.1); border-left: 4px solid #ef4444; padding: 10px 12px; border-radius: 4px;">
                            ...
                            <p style="margin-bottom: 8px;">/do 使用 15號 手術刀切開皮膚，逐層分離組織以充分暴露關節腔</p>
                            
                            <p style="margin-bottom: 4px;"><strong>[步驟二：崁頓解除與解剖復位]</strong></p>
                            <p style="margin-bottom: 8px;">/do 使用復位鉗撥開夾雜之軟組織與崁頓構造，將關節頭精準導回關節窩</p>
                            
                            <p style="margin-bottom: 4px;"><strong>[步驟三：韌帶修補與精細縫合]</strong></p>
                            <p style="margin-bottom: 4px;">/do 使用可吸收縫線修補受損之關節囊與韌帶構造</p>
                            <p style="margin-bottom: 4px;">/do 使用 4-0 Monocryl 可吸收線執行「皮內縫合」(Subcuticular Stitch)</p>
                            <p style="margin-bottom: 4px;">/do 於傷口表面塗抹 Dermabond (醫用膠水) 形成抗菌保護膜</p>
                            <p style="margin: 0;">/do 使用石膏支架將關節固定於功能位置，限制活動</p>
                        </div>
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🚑 EMS 現場中毒處置</h3>
                <ul>
                    <li>/do 保持病患側臥 (Left Lateral Decubitus) 預防嘔吐窒息</li>
                    <li>/do 給予高濃度氧氣，並持續監測心電圖 (EKG) 變化</li>
                </ul>
            </div>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 於粗口徑洗胃管 (36-40 Fr) 前端塗抹 Lidocaine 凝膠潤滑</p>
                    <p>/do 經鼻腔引導管路進入食道，並確認進入胃部 (聽診氣泡音)</p>

                    <strong>2. 循環灌洗 (Lavage Phase)</strong>
                    <p>/do 注入 250ml 生理食鹽水，隨即利用重力或吸引器回抽</p>
                    <p>/do 反覆執行上述動作，直至回流液呈現澄清且無異味為止</p>

                    <strong>3. 活性碳給藥 (Decontamination)</strong>
                    <p>/do 經管路注入 50g 活性碳 (Activated Charcoal) 懸浮液</p>

                    <strong>4. 移除管路與觀察</strong>
                    <p>/do 快速拔除洗胃管並清理口鼻分泌物</p>
                    <p>/do 靜脈注射大量的生理食鹽水，加速腎臟代謝稀釋毒素</p>
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🚑 ER 緊急減壓 (穿刺)</h3>
                <ul>
                    <li>/do 判定 Beck's Triad，於劍突下 45 度角刺入 18G 長針</li>
                    <li>/do 回抽暗紅色不凝固血液，暫時緩解心包填塞壓力</li>
                </ul>
            </div>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 執行全身麻醉與 RSI 氣管插管，維持 100% 給氧</p>
                    ...
                    <p>/do 使用止血鉗提起心包膜並用剪刀縱向剪開，釋放所有積血</p>
                    <p>/do 發現心室裂口，立即使用手指暫時按壓止血</p>
                    <p>/do 使用 3-0 Prolene 不可吸收線搭配「墊片 (Pledget)」進行褥式縫合</p>
                    <p>/do 確保縫合不傷及冠狀動脈，確認心室不再噴血</p>

                    <strong>4. 關閉與免拆線處理</strong>
                    <p>/do 置入 32Fr 胸管引流；使用強力可吸收線執行肋骨對合</p>
                    <p>/do 使用 4-0 Monocryl 執行皮內縫合，外層覆蓋醫用膠水</p>
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🚑 術前準備與誘導</h3>
                <ul>
                    <li>/do 執行快速序列誘導 (RSI)，靜脈推注 Propofol 確保深層麻醉</li>
                    <li>/do 使用 10% Betadine 由劍突至恥骨大面積消毒，鋪設剖腹單</li>
                    <li>/do 留置鼻胃管 (NG Tube) 減壓，預防胃內容物反流</li>
                    <li>/do 建立自體血液回收系統 (Cell Saver)，備好 4 單位紅血球 (pRBC)</li>
                </ul>
            </div>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 執行「四象限塞紗包紮」(Four-quadrant Packing) 以暫時壓迫止血</p>
                    <p>/do 使用血管鉗夾閉出血之腸系膜血管，並以 Prolene 線縫合</p>

                    <strong>3. 損傷控制與沖洗</strong>
                    <p>/do 以 5000ml 溫生理食鹽水反覆沖洗腹腔，移除汙染與血塊</p>
                    <p>/do 放置 JP 引流管於盆腔低處，監測術後滲血狀況</p>

                    <strong>4. 腹壁關閉與免拆線處理</strong>
                    <p>/do 使用 #1 粗規格可吸收線執行「筋膜層」強力連續縫合</p>
                    <p>/do 使用 4-0 Monocryl 執行皮內縫合，外層覆蓋 Dermabond 醫用膠水</p>
    ...
    <div class="clinical-dashboard">
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                <h3>🚑 術前急救與誘導</h3>
                <ul>
                    <li>/do 執行 RSI 氣管插管 (On Endo)，給予 Mannitol (甘露醇) 降低顱內壓</li>
                    <li>/do 剃除手術區域頭髮，使用 Betadine 與酒精進行頭皮三層消毒</li>
                    <li>/do 靜脈推注 Propofol 與肌鬆劑，維持病患於深層麻醉狀態</li>
                </ul>
            </div>
            ...
            <div class="panel in-hospital">
                ...
                <div class="procedure-box">
                    ...
                    <p>/do 使用 10號 刀片執行弧形切開，翻開頭皮瓣並以止血鉗固定出血點</p>
                    <p>/do 使用氣動鑽 (Cranial Drill) 於顱骨執行三處定位鑽孔</p>
                    <p>/do 使用銑刀 (Craniotome) 連接孔洞，取下骨瓣並浸泡於生理食鹽水中</p>
                    
                    <strong>2. 硬腦膜切開與清創 (Evacuation)</strong>
                    <p>/do 使用 11號 尖刀小心切開硬腦膜 (Dura)，顯露下方之暗紅色血塊</p>
                    <p>/do 使用溫生理食鹽水緩慢沖洗，利用雙極電燒 (Bipolar) 對皮質出血點精確止血</p>
                    <p>/do 使用吸引器輕柔移除壓迫腦組織之血腫 (Hematoma)，解除腦幹擠壓</p>

                    <strong>3. 置入監測器與關閉 (ICP & Closure)</strong>
                    <p>/do 於非優勢大腦半球鑽設小孔</p>
                    <p>/do 穿透硬腦膜，置入細長之 ICP 纖維導管至側腦室 (Intraventricular)</p>
                    <p>/do 將導管末端經由皮下隧道 (Tunneling) 導出，遠離骨瓣切口以防感染</p>
                    <p>/do 使用可吸收縫線 (Vicryl) 嚴密縫合硬腦膜，確保無腦脊髓液滲漏</p>
                    <p>/do 放回骨瓣並以鈦合金骨釘固定，小心避開導管路徑以免擠壓</p>
                    <p>/do 使用 4-0 Monocryl 執行皮內縫合，外層覆蓋醫用膠水</p>
        ...
        <div class="dashboard-grid">
            <div class="panel pre-hospital">
                ...
                <ul>
                    ...
                    <li>/do 傾聽與觀察胸廓起伏，評估患者自主呼吸與脈搏狀態</li>
                </ul>
                ...
                <div style="display: flex; flex-direction: column; gap: 8px; margin: 12px 0;">
                    ...
                    <div style="background: rgba(239, 68, 68, 0.1); border-left: 4px solid #ef4444; padding: 10px 12px; border-radius: 4px;">
                        ...
                        <p style="margin: 0;">/do 立即啟動 CPR 高品質胸外按壓，並使用 BVM 提供 5 次初始人工通氣</p>
                    </div>
                    ...
                    <div style="background: rgba(16, 185, 129, 0.1); border-left: 4px solid #10b981; padding: 10px 12px; border-radius: 4px;">
                        ...
                        <p style="margin: 0;">/do 將患者身體擺放為側臥復甦姿勢 (Recovery Position)，防止嘔吐物誤吸</p>
                    </div>
                </div>
